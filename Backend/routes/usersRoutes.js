...
router.route('/').get(authAdminProtect, getUsers).post(validatePassword, createUser)
...
router.route('/notifications/:id').put(authUserProtect, checkUserStatus, notificationUpdate)
