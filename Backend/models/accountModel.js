...
const withdrawLogSchema = new mongoose.Schema(
  {
    withdrawed_amount: {
      ...
      min: [100, 'You Can Not Withdraw Balance Less Than 100'],
    },
  },
  {
    timestamps: true,
...
const depositLogSchema = new mongoose.Schema(
  {
    depositted_amount: {
      ...
      min: [100, 'You Can Not Deposit Balance Less Than 100'],
    },
  },
  {
    timestamps: true,
...
const accountSchema = new mongoose.Schema(
  {
    ...
    credit_score: {
      type: Number,
      default: 0,
      min: [0, 'Credit Score Can Not Be Less Than 0'],
      max: [100, 'Credit Score Can Not Be More Than 100'],
    },
